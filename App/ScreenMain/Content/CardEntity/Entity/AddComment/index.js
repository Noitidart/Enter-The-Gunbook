    ...
    render() {
        ...
        return (
            <View style={styles.addComment}>
                <TextInput style={styles.addCommentInput} keyboardAppearance="dark" onChangeText={this.handleChangeText} placeholder="Leave a comment" placeholderTextColor="#858D90" selectionColor="#5677FC" underlineColorAndroid="transparent" body={body} disableFullscreenUI multiline />
